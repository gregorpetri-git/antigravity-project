      ...
      >
        ...
        <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-8">
          ...
          <div className="text-center mb-6">
            <h1 className="text-2xl font-semibold text-gray-900">Garage Access</h1>
            <p className="text-sm text-gray-500 mt-1 uppercase tracking-wide">
              Enter your digital showroom.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full btn-primary py-3 rounded-md font-medium disabled:opacity-50"
            >
              {isLoading ? 'PLEASE WAIT...' : 'ENTER GARAGE'}
            </button>
          </form>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 py-3 border border-gray-200 rounded-md hover:bg-gray-50 transition-colors disabled:opacity-50"
          >
